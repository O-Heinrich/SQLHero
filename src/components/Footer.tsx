...
export const Footer: React.FC = (): React.ReactElement => {
    ...
    return (
        <footer className="flex justify-center items-center min-h-16 backdrop-blur-xl z-100 sticky bg-slate-200/20 dark:bg-slate-900/20 dark:text-white border-t border-gray-300 dark:border-slate-700 py-2 bottom-0">
