...
export const Header: React.FC = (): React.ReactElement => {
    ...
    return (
        <>
            ...
            <header ref={headerRef} className={clsx('border-b-1 border-gray-100/40 dark:border-gray-100/20  border-groove', 'top-header', 'relative', 'sticky', 'top-0', 'z-[9999]', 'dark:bg-red-500/50', 'bg-red-800/50', 'text-white', !isFirefox && 'backdrop-blur-xl', 'transition-all', 'duration-800', 'dark:mix-blend-color-dodge', 'mix-blend-hard-light')}>
