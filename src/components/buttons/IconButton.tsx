...
export const IconButton: React.FC<IconButtonProps> = ({ 
    ...
    <Button className={clsx(
        ...
        props.variant === 'primary' && 'primary focus:ring-offset-teal-300! dark:focus:ring-offset-teal-800! bg-teal-300! dark:active:bg-teal-800/50! active:bg-green-600! shadow-white hover:bg-teal-200! dark:bg-teal-900! hover:dark:bg-teal-800!  hover:shadow-inner-teal-200 border-teal-500! dark:border-teal-600!',
